...
import AppUsersFormModal from 'view/appUsers/form/AppUsersFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/appUsers/appUsersSelectors';

class AppUsersAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return AppUsersService.listAutocomplete(value, limit);
  };
...
export default connect(select)(AppUsersAutocompleteFormItem);
